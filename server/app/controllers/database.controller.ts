...
export class DatabaseController {
    ...
    private setupRoutes(): void {
        this.router.post('/create', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
            try {
        ...
        this.router.put('/update/:id', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
            try {
        ...
        this.router.delete('/delete/:id', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
            try {
        ...
        this.router.get('/get-all', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
            try {
