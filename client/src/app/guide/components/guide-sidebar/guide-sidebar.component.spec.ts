...
class SecondGuideContentMock implements GuideContent {}
class ThirdGuideContentMock implements GuideContent {}
class FourthGuideContentMock implements GuideContent {}
...
const secondGuideNodeMock: GuideNode = {
    ...
    guide: SecondGuideContentMock,
    previousGuideNode: FirstGuideContentMock,
};
const thirdGuideNodeMock: GuideNode = {
    name: 'ThirdGuideNodeMock',
    guide: ThirdGuideContentMock,
    previousGuideNode: SecondGuideContentMock,
};
const fourthGuideNodeMock: GuideNode = {
    name: 'FourthGuideNodeMock',
    guide: FourthGuideContentMock,
    previousGuideNode: ThirdGuideContentMock,
};
...
describe('GuideSidebarComponent', () => {
    ...
    it('#NestedTreeControl should be set to be the children of the passed guideNode', () => {
    ...
    it('#expandAllMenus should recursively call #expandLayer', () => {
        const expandLayerSpy = spyOn<any>(guideSidebarComponent, 'expandLayer').and.callThrough(); // tslint:disable-line: no-any
        guideSidebarComponent.expandAllMenus();
        expect(expandLayerSpy).toHaveBeenCalledTimes(2);
    });

    it("#get currentGuideNode should return the guideService's currentGuideNode attribute", () => {
    ...
    it("#set currentGuideNode should set the guideService's currentGuideNode attribute", () => {
