...
export const GuideData: GuideNode[] = [
  {
      ...
      children: [
          {
              ...
              children: [
                  { name: 'Aérosol',
                    guide: GuideSpraypaintComponent },
                  { name: 'Crayon',
                    guide: GuidePencilComponent },
                  { name: 'Pinceau',
                    guide: GuidePaintbrushComponent },
                  { name: 'Plume',
                    guide: GuideCalligraphyComponent },
              ]
          }, {
              name: 'Formes',
              children: [
          ...
          { name: 'Texte',
            guide: GuideTextComponent },
          { name: 'Sélection',
            guide: GuideSelectComponent },
      ]
  }, {
      ...
      children: [
          ...
          { name: 'Magnétisme',
            guide: GuideSnapToGridComponent },
      ]
  }, {
