...
describe('GalleryComponent', () => {
    ...
    it("#get drawings should return galleryService's drawings", () => {
        const galleryServiceStub = ({ drawings: initialDrawings } as unknown) as GalleryService;
        component['galleryService'] = galleryServiceStub; // tslint:disable-line: no-string-literal
