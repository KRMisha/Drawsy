...
export default {
    ...
    Rectangle: { name: 'Rectangle', icon: 'blur_on' } as ToolData,
    Selection: { name: 'Sélection', icon: 'crop_5_4' } as ToolData,
    ...
    Eraser: { name: 'Efface', icon: 'format_paint' } as ToolData,
    SprayCan: { name: 'Aérosol', icon: 'select_all' } as ToolData,
    Recolor: { name: 'Applicateur de couleur', icon: 'delete_sweep' } as ToolData,
};
