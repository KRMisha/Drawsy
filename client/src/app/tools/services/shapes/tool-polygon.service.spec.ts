...
fdescribe('ToolPolygonService', () => {
    ...
    it('#updateShape should call renderer.setAttribute with the appropriate parameters when the number of sides is the minimum', () => {
    ...
    it('#updateShape should call renderer.setAttribute with the appropriate parameters for 6 sides', () => {
        const shape = {} as SVGElement;
        toolPolygon['shape'] = shape; // tslint:disable-line: no-string-literal
        ...
        const pointString = '5, 0 9.330127018922193, 2.5 9.330127018922195, 7.499999999999999 5.000000000000002, 10 0.6698729810778072, 7.500000000000002 0.6698729810778046, 2.500000000000003 ';
    ...
    it('#updateShape should call renderer.setAttribute with the appropriate parameters when the number of sides is the maximum', () => {
        const shape = {} as SVGElement;
        toolPolygon['shape'] = shape; // tslint:disable-line: no-string-literal
